      ...
      <div className="session-content">
        ...
        <div className="session-row-footer">
          ...
          <div className="session-row-actions">
            ...
            <button
              type="button"
              className={`session-archive-toggle ${archived ? "active" : ""}`}
...
function ArchiveGlyph() {
  return (
    <svg viewBox="0 0 16 16" aria-hidden="true" className="session-tag-glyph">
      <path
        d="M2.5 3.5h11l-.7 2.2a1 1 0 0 1-.95.7H4.15a1 1 0 0 1-.95-.7Zm1 4h9v4.25a1.25 1.25 0 0 1-1.25 1.25h-6.5A1.25 1.25 0 0 1 3.5 11.75Zm3.25 1.75v1h2.5v-1Z"
        fill="currentColor"
      />
    </svg>
  );
